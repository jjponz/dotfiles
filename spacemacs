...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(solarized-theme doom-themes editorconfig flycheck-mypy importmagic all-the-icons flatui-theme)
